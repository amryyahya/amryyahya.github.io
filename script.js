...
// process image
let addImage = async () => {
    let educationImage = ['amry-yahya.png','sd.jpg','smp.jpg','sma.jpeg','kuliah.webp','movie-search.png','resepin.png'];
    let educationId= ['profile','sd','smp','sma','kuliah','movie-search','resepin'];
...
window.onload = function() {
    typingEffect("Hello There, my name is Amry Yahya, I am a student of Informatics Engineering at University of Brawijaya. Thanks for visiting my portfolio website :)", 0, "", 50);
    addImage();
